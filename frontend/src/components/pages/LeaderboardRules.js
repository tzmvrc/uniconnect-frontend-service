...
const LeaderboardsRules = () => {
  ...
  return (
    <aside className="w-[300px] fixed top-[85px] right-0 h-[calc(100vh-96px)] bg-white p-2 hidden lg:block z-10">
      <div className="p-4 rounded-2xl border-[1px] border-black bg-[#FFCDA9] h-full">
        ...
        <div className="text-left text-[12px]">
          <h2 className="font-bold mb-[8px] text-black">Instructions:</h2>
          ...
          <h2 className="font-bold mb-[8px] mt-[30px] text-black">Tips:</h2>
          <ul className="list-disc pl-5">
            <li>
