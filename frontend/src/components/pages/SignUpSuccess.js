  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="flex flex-col items-center text-center bg-[#fbcaa4] w-[350px] md:w-[800px] h-[350px] md:h-[390px] rounded-[20px]"
          variants={itemVariants}
        >
          <motion.img
            src={successIcon}
          ...
          >
            ...
            board! Here are few things you can do to get started:
          </motion.p>

          <motion.button
            type="submit"
            class="w-[130px] p-[8px] rounded-[10px] bg-[#eb6e5b] text-white text-[16px] font-[550] cursor-pointer flex justify-center shadow-[0_5px_3px_rgba(0,0,0,0.2)] transition-all duration-300 ease-in-out hover:bg-[#d25441]"
            onClick={() => navigate("/signup-add-topics")}
          >
            Get Started
          </motion.button>
        </motion.div>
